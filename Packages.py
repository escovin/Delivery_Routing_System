...
# Times each truck leaves the hub
first_time = '8:00:00'
second_time = '9:10:00'
third_time = '11:00:00'
...
# For loop updates the delivery status of all packages in first truck through the time the truck leaves the station.
i = 0  # Counter for loop iteration.
...
for value in check_first_truck_first_trip():
    ...
    i += 1
# For loop compares the addresses on the first truck to the list of addresses and adds the address index to the list
...
try:
    ...
    pass
# Calls greedy algorithm that sorts the packages into a more efficient order
...
for index in range(len(first_optimized_truck_index())):
    try:
        # Calculates total distance of truck.
        ...
        # Calculates distance of each package along the route.
        ...
        pass
# For loop updates the delivery status of all packages in second truck through the time the truck leaves the station.
i = 0  # Counter for loop iteration
# Space-time complexity is O(N)
...
##second_delivery.insert(0, second_delivery.pop(9))

##print(second_delivery)


# For loop compares the addresses on second truck to the list of addresses and adds the address index to the list
# Space-time complexity is O(N^2)
try:
...
# For loop takes the values in the second truck and runs them through the distance functions in the Distances.py file
# Space-time complexity is O(N)
...
for index in range(len(second_optimized_truck_index())):
    try:
        ...
        pass
##print(second_optimized_truck_index())
##second_optimized_truck_index().insert(0, second_optimized_truck_index().pop(4))
##print(second_optimized_truck_index())


# For loop updates the delivery status of all packages in first truck (on second delivery) to 'In transit'
i = 0
# Space-time complexity is O(N)
for value in check_first_truck_second_trip():
    ...
    i += 1
# For loop compares the addresses on first truck (on second delivery) to the list of addresses and adds the address index to the list
# Space-time complexity is O(N^2)
try:
...
##print(check_second_truck_first_trip())
##check_second_truck_first_trip().insert(0, check_second_truck_first_trip().pop(9))
##print(check_second_truck_first_trip())

# Calls the greedy algorithm that sorts the packages into a more efficient order
calculate_shortest_distance(third_delivery, 3, 0)
third_truck_total_distance = 0
# For loop takes the values in the third truck and runs them through the distance functions in the Distances.py file
# Space-time complexity is O(N)
third_truck_package_id = 0
for index in range(len(third_optimized_truck_index())):
    try:
        # Calculates total distance of the truck
